...
if __name__ == "__main__":
    ...
    agent_without = Agent.create(agent='agentpid.json', environment=environment,exploration=exploration)
    ...
    pickle.dump(reward_record_without, open( "PID_without_record.p", "wb"))
    ...
    pickle.dump(evaluation_reward_record_without, open( "PID_evaluation_without_record.p", "wb"))
    agent_without.close()
    environment.close()