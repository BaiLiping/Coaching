...
for k in range(len(prohibition_position)):
    ...
    for i in range(len(prohibition_parameter)):
        ...
        for _ in tqdm(range(episode_number)):
            ...
            while not terminal:
                y_position=states[1]
                if y_position>=0.8*prohibition_position[k] and y_position<prohibition_position[k]:
                    states_restore=states
                elif y_position<=-0.8*prohibition_position[k] and y_position>-prohibition_position[k]:
                    states_restore=states
